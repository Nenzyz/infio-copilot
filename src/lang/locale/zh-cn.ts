...
export default {
	...
	settings: {
		...
		ModelProvider: {
			...
			testConnection: {
				testApiConnection: '获取可用模型',
				testingConnection: '正在获取模型...',
				connectionSuccess: '模型加载成功',
				connectionFailed: '获取模型失败',
				notSupported: '不支持从 {provider} 获取模型',
				...
				serverError: '服务器内部错误',
				noDefaultModel: '{provider} 没有可用的模型',
				invalidResponse: '响应格式无效',
				// UI 文本
				showApiKey: '显示 API Key',
				hideApiKey: '隐藏 API Key',
				testConnectionTooltip: '获取该提供商的可用模型',
				testing: '加载中...',
				success: '已加载模型',
				failed: '失败',
				test: '获取模型',
