export default {
	...
	settings: {
		...
		ModelProvider: {
			...
			testConnection: {
				testApiConnection: 'Get Available Models',
				testingConnection: 'Fetching models...',
				connectionSuccess: 'Models loaded successfully',
				connectionFailed: 'Failed to fetch models',
				notSupported: 'Fetching models from {provider} is not supported',
				...
				noDefaultModel: 'No models available for {provider}',
				invalidResponse: 'Invalid response format',
				// UI text
				showApiKey: 'Show API Key',
				hideApiKey: 'Hide API Key',
				testConnectionTooltip: 'Fetch available models for this provider',
				testing: 'Loading...',
